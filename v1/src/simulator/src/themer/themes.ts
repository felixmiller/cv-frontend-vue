...
const themes: Themes = {
    ...
    'Print (B&W)': {
        '--node-intermediate': 'hidden',
        '--node-endpoint': 'hidden',
        '--text-navbar--alt': '#000000',
        '--br-secondary': '#000000',
        '--br-circuit-cur': '#000000',
        ...
        '--qp-br-tl': '#333333',
        '--qp-br-rd': '#333333',
        '--qp-box-shadow-1': '#333333',
        '--qp-box-shadow-2': '#333333',
        '--bg-circuit': '#dddddd',
        '--br-circuit': '#000000',
        '--br-primary': '#000000',
        '--bg-primary-moz': '#333333e6',
        '--bg-primary-chr': '#333333b3',
        '--bg-tabs': '#888888',
        '--bg-icons': '#666666',
        '--bg-text': '#cccccc',
        '--bg-secondary': '#aaaaaa',
        ...
        '--canvas-fill': '#ffffff',
        '--context-text': '#ffffff',
        '--bg-toggle-btn-primary': '#555555',
        '--primary-btn-hov': '#444444',
        '--btn-danger': '#555555',
        '--btn-danger-darken': '#444444',
        '--disable': '#999999',
        ...
        '--stroke': '#000000',
        '--fill': '#ffffff',
        '--hover-and-sel': 'rgba(200, 200, 200, 0.5)',
        '--wire-draw': '#000000',
        '--wire-cnt': '#000000',
        '--wire-pow': '#000000',
        '--wire-sel': '#000000',
