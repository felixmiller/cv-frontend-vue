 ...
 * @class
 * TFF
 * Configurable T flip flop with labeled ports (74-series style).
 * Box resizes when Enable is toggled.
 * @extends CircuitElement
 * @category sequential
 */
export default class TFF extends CircuitElement {
    constructor(
        ...
        // T at (0,4), CLK at (0,2) from bottom-left in grids; EN extends box downward when active
        const hh = hasEnable ? 50 : 30
        this.setDimensions(30, hh)
        this.tInp = new Node(-30, -10, 0, this, 1, 'T')
        this.clkInp = new Node(clockPolarity === 'neg' ? -40 : -30, 10, 0, this, 1, 'Clock')
        this.qOutput = new Node(40, -10, 1, this, 1, 'Q')
        this.qnOutput = new Node(40, 10, 1, this, 1, 'Qn')
    ...
    customDraw() {
        ...
        fillText3(ctx, 'T', -25, this.tInp.lefty, xx, yy, 14, 'Raleway', 'left')
...
TFF.prototype.tooltipText = 'T Flip Flop: Toggles on active clock edge when T=1'
TFF.prototype.objectType = 'TFF'
TFF.prototype.helplink = 'https://docs.circuitverse.org/chapter4/chapter4-sequentialelements/#t-flip-flop'

TFF.prototype.mutableProperties = {
    resetType: {
        name: 'Reset Type',
        type: 'select',
